 ...
 * <p>Populates the {@link ee.example.model.ServiceInfo#xlServiceEndTime} field.</p>
 *
 * @see ee.example.converter.rules.ServiceInfoConvertionRule
 * @author Vahur Kaar
 * @since 25.03.2015
 */
public class ServiceInfoXlServiceEndTimeConvertionRule extends ServiceInfoConvertionRule {

    public ServiceInfoXlServiceEndTimeConvertionRule(Integer valueStartPosition, Integer valueLength) {
    ...
    protected void populateField(ServiceInfo serviceInfo, String value) {
        if (StringUtils.isNotBlank(value)) {
            serviceInfo.setXlServiceEndTime(value.substring(0, 2) + ":" + value.substring(2));
        }
    }
}
